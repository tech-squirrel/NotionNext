...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，我是有技术的松鼠, Hi，我是梦想能躺着赚钱的人,Hi，我是一个干饭人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '有技术的松鼠', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '梦想能躺着赚钱', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://松鼠.com', // 网站地址
